...
def main():
    ...
    castle_maker.tower_building(x+3, y+1, z+6, width=22, height=8, length=20, butt_height=6)
    castle_maker.tower_building(x+3, y+9, z+6, width=22, height=10, length=20, butt_height=9)
